...
Response::Response(RawResponse rawResponse, bitset_4B bitset)
    : m_rawResponse(std::move(rawResponse)), m_dataType(DataType::bitset), m_dataBitset(bitset)
{
}

Response::Response(RawResponse rawResponse,
                   std::string data, std::string type)
    : m_rawResponse(std::move(rawResponse)), m_dataType(DataType::string), m_stringData(std::move(data), std::move(type))
{
}

Response::Response(RawResponse rawResponse,
                   float data, std::string unit)
    : m_rawResponse(std::move(rawResponse)), m_dataType(DataType::number), m_floatData1(data, std::move(unit))
{
}
...
Response::Response(RawResponse rawResponse,
    ...
    : m_rawResponse(std::move(rawResponse)), m_dataType(DataType::numberPair),
      m_floatData1(data1, std::move(unit1)), m_floatData2(data2, std::move(unit2))
{
}
